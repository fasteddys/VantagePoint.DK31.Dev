...
namespace MVC
{
    public static class Views
    {
        ...
        public static class AdvancedSamples
        {
            ...
            {
                public const string BasicInit = "~/Modules/AdvancedSamples/DataTables/BasicInit.cshtml";
                public const string ServerSide = "~/Modules/AdvancedSamples/DataTables/ServerSide.cshtml";
            }

            public static class Editors
            {
                public static class InputWithInlineButtons
                {
                    public const string Index = "~/Modules/AdvancedSamples/Editors/InputWithInlineButtons/Index.cshtml";
                }

                public static class MultiDatesPicker
                {
                    public const string Index = "~/Modules/AdvancedSamples/Editors/MultiDatesPicker/Index.cshtml";
                }

                public static class ProductPicker
                {
                    public const string Index = "~/Modules/AdvancedSamples/Editors/ProductPicker/Index.cshtml";
                }
            ...
            public static class Forms
            {
                public static class BootstrapForm
                {
                    public const string BootstrapFormEdit = "~/Modules/AdvancedSamples/Forms/BootstrapForm/BootstrapFormEdit.cshtml";
                    public const string BootstrapFormList = "~/Modules/AdvancedSamples/Forms/BootstrapForm/BootstrapFormList.cshtml";
                }

                public static class EntityGridDialog
                {
                    public const string Index = "~/Modules/AdvancedSamples/Forms/EntityGridDialog/Index.cshtml";
                }

                public static class OrderWizard
                {
                    public const string Index = "~/Modules/AdvancedSamples/Forms/OrderWizard/Index.cshtml";
                }
            ...
            {
                public static class AutoColumnWidth
                {
                    public const string Index = "~/Modules/AdvancedSamples/Grids/AutoColumnWidth/Index.cshtml";
                }

                public static class CustomizableSummaries
                {
                    public const string Index = "~/Modules/AdvancedSamples/Grids/CustomizableSummaries/Index.cshtml";
                }

                public static class DragDropGrouping
                {
                    public const string Index = "~/Modules/AdvancedSamples/Grids/DragDropGrouping/Index.cshtml";
                }

                public static class ExcelStyleFilters
                {
                    public const string Index = "~/Modules/AdvancedSamples/Grids/ExcelStyleFilters/Index.cshtml";
                }

                public static class SplitMasterDetail
                {
                    public const string Index = "~/Modules/AdvancedSamples/Grids/SplitMasterDetail/Index.cshtml";
                }
            ...
            public static class Misc
            {
                ...
                {
                    public const string DataExplorerIndex = "~/Modules/AdvancedSamples/Misc/DataExplorer/DataExplorerIndex.cshtml";
                }

                public static class IdleTimeout
                {
                    public const string IdleTimeoutIndex = "~/Modules/AdvancedSamples/Misc/IdleTimeout/IdleTimeoutIndex.cshtml";
                }
            }
            public const string PremiumSourceWarning = "~/Modules/AdvancedSamples/PremiumSourceWarning.cshtml";
        }
