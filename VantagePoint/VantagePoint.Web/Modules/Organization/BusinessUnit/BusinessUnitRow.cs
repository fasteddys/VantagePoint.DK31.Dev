...
namespace VantagePoint.Organization.Entities
{
    [ConnectionKey("Default"), Module("Organization"), TableName("BusinessUnits")]
    [DisplayName("Business Units"), InstanceName("Business Unit")]
    [ReadPermission(PermissionKeys.BusinessUnits.Management)]
    [ModifyPermission(PermissionKeys.BusinessUnits.Management)]
    [LookupScript(Permission = PermissionKeys.General)]
